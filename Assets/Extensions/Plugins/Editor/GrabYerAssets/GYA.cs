...
namespace XeirGYA
{
    public partial class GYA : EditorWindow
    {
        ...
        // GYA Version
        internal static string gyaVersion = GYAVersion.SetAppVersion(3, 19, 2, 13, 1);
        ...
        internal void TBPopUpMarked(float xPos)
        {
            ...
            if (GYAPackage.countMarkedToImport > 0)
            {
                ...
                markedMenu.AddItem(new GUIContent("Deselect All"), false, TBPopUpCallback, "ClearMarked");
                markedMenu.AddSeparator("");
            ...
            else
            {
                ...
                markedMenu.AddDisabledItem(new GUIContent("Deselect All"));
                markedMenu.AddSeparator("");
                markedMenu.AddItem(new GUIContent("Export List as CSV"), false, TBPopUpCallback, "ExportListAsCSV");
            }
